...
def parse_file_equipement_culture_csv(filename,delimiter='\n', separator=';'):
  ...
  for line in lines:
	...
	datafile.write('INSERT INTO `points_of_interest`(`label`, `description`,`gps_id`, `type`, `type_id_in_table`, `contact_id`) VALUES ("'+aline[1]+'","'+aline[7]+'",'+str(90+i-1)+',"no_table",0,'+str(id_contact)+');\n')
	...
	datafile.write('INSERT INTO `points_of_interest`(`label`, `description`,`gps_id`, `type`, `type_id_in_table`) VALUES ("'+aline[1]+'","'+aline[7]+'",'+str(90+i-1)+',"no_table",0);\n')
    i+=1
  print "done"
